            ...
            <div class="articles">
                ...
                <div class="articles__item">
                    <a href="#" class="articles__link">
                        <div class="articles__img">
                            <img src="{{asset('/blog/img/banner/lara.png')}}" class="articles__img-src">
                        </div>
                        <div class="articles__title">
                ...
                <div class="articles__item">
                    <a href="#" class="articles__link">
                        <div class="articles__img">
                            <img src="{{asset('/blog/img/banner/php.png')}}" class="articles__img-src">
                        </div>
                        <div class="articles__title">
                ...
                <div class="articles__item">
                    <a href="#" class="articles__link">
                        <div class="articles__img">
                            <img src="{{asset('/blog/img/banner/react-redux.png')}}" class="articles__img-src">
                        </div>
                        <div class="articles__title">
                            <h2>فریم ورک لاراول فریم ورک لاراول فریم ورک فریم ورک لاراول فریم ورک لاراول فریم ورک لاراول
                                فریم ورک لاراول فریم ورک لاراول</h2>
                ...
                <div class="articles__item">
                    <a href="#" class="articles__link">
                        <div class="articles__img">
                            <img src="{{asset('/blog/img/banner/reactjs.png')}}" class="articles__img-src">
                        </div>
                        <div class="articles__title">
                            <h2>فریم ورک لاراول فریم ورک لاراول فریم ورک فریم ورک لاراول فریم ورک لاراول فریم ورک لاراول
                                فریم ورک لاراول فریم ورک لاراول</h2>
                        ...
                        <div class="articles__details">
                            <div class="articles__author">نویسنده : بهنام</div>
                            <div class="articles__date">تاریخ : 1399/09/22</div>
                        </div>
                    </a>
                </div>
                ...
                <div class="articles__item">
                    <a href="#" class="articles__link">
                        <div class="articles__img">
                            <img src="{{asset('/blog/img/banner/restfull-lara.jpg')}}" class="articles__img-src">
                        </div>
                        <div class="articles__title">
                            <h2>فریم ورک لاراول فریم ورک لاراول فریم ورک فریم ورک لاراول فریم ورک لاراول فریم ورک لاراول
                                فریم ورک لاراول فریم ورک لاراول</h2>
